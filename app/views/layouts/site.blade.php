    	...
    	<div class="large-6 columns">
			<div id="teaser-slider-2">
							<!-- <div class="flexslider">
								<ul class="slides">
									<li>
										<img src="/assets/img/slides/iphoneshots-1.jpg" alt="Petrichor - slider">
									</li>
									<li>
										<img src="/assets/img/slides/iphoneshots-2.jpg" alt="Petrichor - slider">
									</li>
									<li>
										<img src="/assets/img/slides/iphoneshots.jpg" alt="Petrichor - slider">
									</li>
								</ul>
							</div>  -->
						</div>
...
<div id="infos" class="section infos" data-magellan-destination="infos">
	<div class="row hi-icon-wrap hi-icon-effect-3 hi-icon-effect-3b">
		<div class="large-4 columns feature">
			...
			<h3>Dados</h3>
			<p>Todos os dados são provenientes do site http://www.desaparecidos.gov.br e atualizados 1 vez ao dia.

</p>
		</div>
		<div class="large-4 columns feature">
			<span class="icon icon-facebook hi-icon"></span>
			<h3>Compartilhe</h3>
			<p>O aplicativo permite compartilhar dados da pessoa desaparecida no facebook.
...
<!-- <div id="pricing-table" class="section pricing gray" data-magellan-destination="pricing">
 ...
 -->
<div id="contato"  class="section contact gray" data-magellan-destination="contact">
    ...
    <div class="row">
		...
		<form method="post" action="#" id="contactform">
					<div>
						...
						<input type="text" class="input-field" id="nome" name="nome" value="">
					</div>
					<div>
					...
					<div id="error">Mensagem não enviada!</div>
				</form>
...
<footer>
	<div class="row">
		<div class="large-6 columns">
			<ul class="inline-list">
			  <li class="copyright"><?php echo date('Y');?> &copy; DesaparecidosBR.org</a></li>
  ...
  <link rel="stylesheet" href="/assets/css/flexslider.css"> <!-- Flex slider -->
  <script src="/assets/js/jquery.flexslider.js" type="text/javascript"></script><!-- Flex slider -->
  ...
  ga('create', 'UA-1814735-20', 'desaparecidosbr.org');
  ga('send', 'pageview');
